...
//draw_text(70, display_get_gui_height() - 30, "points " + string(global.points));
...
draw_set_halign(fa_left);
var time = 100;
draw_healthbar(display_get_gui_width() - 20, 60, 20, 90, time, c_black, c_red, c_red, 0, false, false);
draw_set_alpha(1);